...
_MaxNum${max_kp_num}_LossScalePre${loss_scale_pre}_LossScaleAb${loss_scale_ab}_Step${assign_steps}_Vocab${vocab_size}_EarStop${early_stop_tolerance}_Epochs${epochs}"

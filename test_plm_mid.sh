...
#echo "============================= train: ${exp} ================================="
#
train_out_dir="output/train/plm/decoder/t5-base/Mid_One2set_PLMt5-base_BS12_MaxLen6_MaxNum20_LossScalePre0.2_LossScaleAb0.1_Step2_EarStop4_Epochs20/"
...
do
  echo "============================= testing ${data} ================================="
  test_out_dir="output/test/plm/decoder/${plm}/${exp}/${data}"

...
def preprocess_opts(parser):
    parser.add_argument('-data_dir', default='./data/kp20k_small', help='The source file of the data')
    parser.add_argument('-save_data_dir', default='./processed_data', help='The saving path for the data')
    parser.add_argument('-remove_title_eos', action="store_true", help='Remove the eos after the title')
    parser.add_argument('-one2many', default= True, action="store_true", help='Save one2many file.')
...
def model_opts(parser):
    ...
    parser.add_argument('-copy_attention', action="store_true", default=False,
    ...
    parser.add_argument('-fix_kp_num_len', action="store_true", default=True,
                        help='fix the maximun kp length and number')
    parser.add_argument('-seperate_pre_ab', action="store_true", default=True,
                        help='Whether use a seperate set loss')
    parser.add_argument('-plm', type=str, default=None,
                        help='Train the model from a plm.')
    parser.add_argument('-encoder', type=str, default=None,
                        help='Train the encoder from a plm.')
    parser.add_argument('-decoder', type=str, default=None,
                        help='Train the decoder from a plm.')
    parser.add_argument('-prompt', type=str, default="generate key phrases from <cls> ",
                        help='Prefix prompt for keyphrase generation')


def train_opts(parser):
    # Model loading/saving options
    parser.add_argument('-data', default='processed_data',
                        help="""Path prefix to the "train.one2one.pt" and
                        "train.one2many.pt" file path from preprocess.py""")
    parser.add_argument('-vocab', default='processed_data',
    ...
    parser.add_argument('-early_stop_tolerance', type=int, default=8,
    ...
    parser.add_argument('-max_grad_norm', type=float, default=1,
                        ...
                        max_grad_norm""")
    parser.add_argument('-loss_normalization', default="batches", choices=['tokens', 'batches'],
    ...
    # One2many options
    parser.add_argument('-one2many', action="store_true", default=True,
    ...
    parser.add_argument('-set_loss', action="store_true", default=True,
...
def predict_opts(parser):
    ...
    parser.add_argument('-kws_file', required=True, help="""Path to keywords file""")
...
def post_predict_opts(parser):
    ...
    parser.add_argument('-kws_file_path', type=str, required=True,
                                    help="Path of the keywords file.")
